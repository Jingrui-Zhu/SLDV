...
\subsection{SW tools}
There are two primary SW environments used by professionals, \emph{Paraview} (an open-source application designed for visualizing both 2D and 3D datasets) and \emph{TTK} - Topology ToolKit (A specialized toolkit for performing the topological analysis including generation of Reeb graphs and persistence diagrams).
