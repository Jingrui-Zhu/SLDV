...
In the fig.\ref{fig13.5}, the simplex in question is a vertex (0-simplex), and its "\textbf{star}" is the union of all the simplices containing the said vertex forming the figure b. Its \textbf{link} is all the faces of the simplices in the star of the vertex that do not intersect with it. 
